                ...
                <div>
                    <div className="flex items-center justify-between py-3 md:py-5 md:block">
                        <a href="javascript:void(0)">
                            <h2 className="text-xl font-bold lg:text-4xl text-primary ">Web Movies</h2>
                        </a>
                ...
                <div>
                    ...
                    >
                        <ul className="items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0">
                            ...
                            <label for="search">
                                <input type="search" name="search" id="search" placeholder="Cari film !" className="font-normal text-base my-6 px-2 py-1 rounded-md shadow-md text-second focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"/>
                            </label>
                        </ul>
                    </div>
                </div>
